...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 12, 2023 at 09:17 AM
...
(10, 9, 'PAY-21700797GV667562HLLZ7ZVY', '2023-03-10');
...
CREATE TABLE `users` (
  ...
  `cat_question_answer` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `users` (`id`, `email`, `password`, `type`, `firstname`, `lastname`, `address`, `contact_info`, `photo`, `status`, `activate_code`, `reset_code`, `created_on`, `cat_question_answer`) VALUES
(1, 'admin@admin.com', '$2y$10$0SHFfoWzz8WZpdu9Qw//E.tWamILbiNCX7bqhy3od0gvK5.kSJ8N2', 1, 'Admin', '', '', '', 'cat4.jpg', 1, '', '', '2023-03-12', 'Toyota'),
(9, 'harry@den.com', '$2y$10$Oongyx.Rv0Y/vbHGOxywl.qf18bXFiZOcEaI4ZpRRLzFNGKAhObSC', 0, 'Harry', 'Den', 'USA', '043223456780', 'male2.png', 1, 'k8FBpynQfqsv', 'wzPGkX5IODlTYHg', '2023-03-09', 'Honda Civic');
